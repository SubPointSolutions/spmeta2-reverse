...
{
    public class UniqueContentTypeFieldsOrderDefinitionValidator :
        TypedReverseDefinitionValidatorBase<UniqueContentTypeFieldsOrderDefinition>
    {
        ...
        public override void DeployModel(object modelHost, DefinitionBase model)
        {
            ...
            var originalDefinition = typedModelHost.OriginalModel.Value.WithAssertAndCast<UniqueContentTypeFieldsOrderDefinition>("value", m => m.RequireNotNull());
            var reversedDefinition = typedModelHost.ReversedModel.Value.WithAssertAndCast<UniqueContentTypeFieldsOrderDefinition>("value", m => m.RequireNotNull());
